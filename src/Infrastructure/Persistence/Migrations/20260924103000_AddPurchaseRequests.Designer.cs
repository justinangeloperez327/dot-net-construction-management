...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924103000_AddPurchaseRequests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Approvals.ApprovalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Approvals.ApprovalStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ApprovalRequestId", "StepNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.DailyReports.DailyReportAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Documents.DocumentRevision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.PurchaseRequests.PurchaseRequest", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "RequestNumber")
                        .IsUnique();

                    b.ToTable("PurchaseRequests", (string)null);
                });

            modelBuilder.Entity("Domain.PurchaseRequests.PurchaseRequestItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.PurchaseRequests.PurchaseRequest", b =>
                {
                    b.HasOne("Domain.Approvals.ApprovalRequest", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.PurchaseRequests.PurchaseRequestItem", b =>
                {
                    b.HasOne("Domain.PurchaseRequests.PurchaseRequest", null)
                        .WithMany("Items")
